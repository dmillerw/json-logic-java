...
public class JsonLogic {
    ...
    private static void addOperation(String key, String alt, VarArgOperation operation) {
        operations.put(key, operation);
        operations.put(alt, operation);
    }
    ...
    private static JsonElement callOperation(String operation, JsonElement data, JsonElement logic) {
        JsonElement[] array;
    ...
    public static JsonElement apply(JsonElement logic, JsonElement data) {
        if (logic.isJsonArray()) {
